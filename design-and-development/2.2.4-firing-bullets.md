...
Load the "barrel" sprite and assign it the name "barrel"
Load the "bullet" sprite and assign it the name "bullet"

Create a bean object with the following properties:
  - sprite: "bean"
  - position: (80, 300)
  - rotation: 0
  - anchor: "center"
...
Add a barrel sprite as a child of the bean object, scaled by (3, 3), and positioned at (0, -60)
...
Create an angle object to display the angle of the player, positioned at (24, 24)

Create a power object to display the power of the shot, positioned at (100, 24)
...
On every game update:
  Update the text of the angle object with the absolute value of the bean's angle
  Update the text of the power object with the bean's power

Set the rotation speed to the SPEED_HIGH of the bean

When the alt key is pressed:
  Set the rotation speed to the SPEED_LOW of the bean

When the alt key is released:
  Set the rotation speed back to the SPEED_HIGH of the bean

When the left key is pressed:
  If the bean's angle is greater than -70:
    Rotate the bean to the left by -rotationSpeed * dt()
  Else:
    Set the bean's angle to -70 to prevent further anticlockwise rotation

When the right key is pressed:
  If the bean's angle is less than 0:
    Rotate the bean to the right by rotationSpeed * dt()
  Else:
    Set the bean's angle to 0 to prevent further rotation in the wrong direction

Initialize a variable "smooth" to 3

When the up key is pressed:
  Increase the "smooth" variable by 1.2 * dt()
  If the bean's power is less than 100:
    Increase the bean's power smoothly based on 0.7 * smooth^2 * dt()
  Else:
    Set the bean's power to 100 to prevent exceeding the maximum power value of 100

When the up key is released:
  Reset the "smooth" variable back to 3

When the down key is pressed:
  Increase the "smooth" variable by 1.2 * dt()
  If the bean's power is greater than 1:
    Decrease the bean's power smoothly based on 0.7 * smooth^2 * dt()
  Else:
    Set the bean's power to 0 to prevent going below the minimum power value of 0
...
The outcome is a working power meter which increases at a rate which I find suitable for the game.

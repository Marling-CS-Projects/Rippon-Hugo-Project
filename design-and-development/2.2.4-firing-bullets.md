...
```
WAJIOJDIOAWJODJAOIWDJODJAOIWDJWIOADJIOAWDJO
```
...
| 2    | Press space                                     | Bullet should come out of the barrel at a low velocity                                   | Power increased and decreased slowly            | Pass      |
| 3    | Press space after increasing power              | Bullet should come from the barrel at a higher velocity                                  | Power level increases and decreases as expected | Pass      |
| 4    | Press space with the barrel at an angle         | Bullet should come out of barrel moving at the same direction as the angle of the barrel | UI works and power is locked between 0 and 100  | Pass      |
| 5    | Monitor bullets after they come from the barrel | Bullets should fall and accelerate under gravity                                         |                                                 |           |
